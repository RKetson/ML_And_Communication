...
"""
    ...
    e outro com abordagem symbol-wise, utilizando receptor convolucional (Net_Conv_v1).
    Ele treina ambos os modelos, avalia seu desempenho em termos de BER e SER, e salva os resultados
    para posterior análise.

    Uso:
        python Compare_Bit_and_Symbol_Wise.py           # Usa pesos salvos se existirem
        python Compare_Bit_and_Symbol_Wise.py --retrain # Força novo treinamento e avaliação
"""

# ============================================================================================ #
# Argumentos de linha de comando
# ============================================================================================ #
parser = argparse.ArgumentParser(description="Comparação Bit-wise vs Symbol-wise Autoencoder (7,4) — Conv")
parser.add_argument(
    "--retrain",
    action="store_true",
...
with strategy.scope():
    symbol_tx = Net_Conv_v1.transmitter(k, n)
    symbol_rx = Net_Conv_v1.receiver(k, n, bit_wise=False)
...
symbol_local_ber_ser_4_7  = f"./Pontos/Autoencoder/Convolutional/AutoEncoder_{k}_{n}_ER_SymbolWise-network_v2"
...
fig_dir = "./Figures/Convolutional/Autoencoder-7-4"
