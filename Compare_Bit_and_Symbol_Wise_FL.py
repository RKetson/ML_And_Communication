...
rx = Net_Full_Con.receiver(k, n, bit_wise=False)
...
# Avalia o modelo treinado
symbol_ber, symbol_ser = aval_model(symbol_model, ebno_dbs, max_iter=75000, block_errors=500, graph_mode="xla", local=symbol_local_ber_ser_4_7)
...
plt.tight_layout()
plt.savefig(f"./Figures/Fully Connected/Autoencoder-7-4/Bit-Wise_Symbol-Wise_Comparison.png")
plt.show()
