...
n           = 7          # Dimensões reais do símbolo transmitido
...
fig.suptitle(f'Autoencoder MI (Symbol-wise) vs Hamming ({n},{k})', fontsize=16, fontweight='bold')
...
for ax, metric_idx, ylabel, title in [
    ...
    if metric_idx == 0:
        ...
        ax.semilogy(ebno_dbs, ref_mld, 'k--', linewidth=2.0, marker='x', markersize=7,
