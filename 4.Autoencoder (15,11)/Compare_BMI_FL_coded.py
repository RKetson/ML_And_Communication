...
for a in A_VALUES:
    ...
    with strategy.scope():
        ...
        lr_schedule = tf.keras.optimizers.schedules.CosineDecay(
            ...
            alpha=1e-2   # LR mínima ao final do treino
        )
...
fig.suptitle(f'Autoencoder (15,11) BMI (Bit-wise) vs Hamming ({n},{k})', fontsize=16, fontweight='bold')
...
for ax, metric_idx, ylabel, title in [
    ...
    # Referência: Hamming(15,11) com Soft Decision
    ...
    # Referência: Hamming(15,11) com Hard Decision
